...
<head>
  ...
  <!-- PULSANTE TOGGLE NAVIGATION FLUID -->
            ...
            <a class="navbar-brand" href="{{ url('/') }}">Il Blog di ROB </a>
...
<header class="intro-header"
        style="background-image: url('{{ url('assets/frontend/img/home-bg.jpg') }}')">

      <div class="container">
        <div class="row">
          <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
            <div class="site-heading">
                    <h1>Il Blog di ROB </h1>
  ...
  <!-- RICHIAMA SECTION'CONTENT' IN HOME.BLADE FOREACH STAMPA  ARTICOLI -->
              @yield('content')
...
<!-- PULSANTI SOCIAL -->
  ...
  <p class="copyright text-muted">Right to Copy © Roberta Randazzo - 2015</p>
